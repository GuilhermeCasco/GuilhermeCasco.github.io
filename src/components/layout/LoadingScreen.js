...
import { Medallion } from "../ui/Medallion.jsx";
...
export function LoadingScreen(props) {
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 z-[100] bg-[var(--color-teal-dark)] flex flex-col items-center justify-center overflow-hidden"
    >
      {/* Fog Layer */}
      ...
      <div
        ref={silhouetteRef}
        className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] opacity-10 pointer-events-none"
      >
        <svg
          viewBox="0 0 100 100"
          fill="currentColor"
          className="text-[var(--color-teal-deep)] w-full h-full"
        >
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        <h1
          ref={textRef}
          className="text-4xl md:text-6xl text-[var(--color-gold)] font-bold tracking-widest border-b-2 border-[var(--color-gold)] pb-4 text-center px-4"
        >
          TITANOMAQUIA
        </h1>
